  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        FadeSlideIn(delay: _delay(2), child: const _HeadingUnderline()),
        const SizedBox(height: AppDimensions.spaceLG),
...
/// A short horizontal accent bar beneath the heading, brightest in the middle
/// so it reads as a soft glow rather than a hard divider.
class _HeadingUnderline extends StatelessWidget {
  const _HeadingUnderline();
