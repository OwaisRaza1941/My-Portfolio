...
/// The centered header of the services section: the "🛠️ WHAT I DO" eyebrow
/// pill, the gradient heading with its accent underline, and a one-sentence
/// summary.
///
/// Mirrors the about and skills headers exactly, so every section on the page
/// opens with the same gesture as it scrolls into view.
class ServicesHeader extends StatelessWidget {
  const ServicesHeader({
    super.key,
    this.titleFontSize = AppDimensions.aboutTitleFontSize,
    this.subtitleFontSize = AppDimensions.aboutSubtitleFontSize,
    this.maxWidth = AppDimensions.servicesHeaderMaxWidth,
  });
      ...
      children: [
        FadeSlideIn(
          ...
          child: const SectionBadge(
            emoji: AppStrings.servicesBadgeEmoji,
            label: AppStrings.servicesBadge,
          ),
        ),
